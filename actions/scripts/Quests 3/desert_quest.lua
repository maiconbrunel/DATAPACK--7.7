...
if item.uid == 16000 then
 ...
 player2pos = {x=32669, y=32089, z=8, stackpos=253}
 player2 = getThingfromPos(player2pos)

 player3pos = {x=32677, y=32089, z=8, stackpos=253}
 player3 = getThingfromPos(player3pos)

 player4pos = {x=32673, y=32093, z=8, stackpos=253}
 player4 = getThingfromPos(player4pos)
  ...
  if player1level >= questlevel and player2level >= questlevel and player3level >= questlevel and player4level >= questlevel then
	  ...
	  queststatus1 = getPlayerStorageValue(player1.uid,2214)
	  queststatus2 = getPlayerStorageValue(player2.uid,2214)
	  queststatus3 = getPlayerStorageValue(player3.uid,2214)
	  queststatus4 = getPlayerStorageValue(player4.uid,2214)
