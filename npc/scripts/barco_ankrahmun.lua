...
local DestinationText = 'I can take you to {Venore}, {Edron}, {Darashia} and {Port Hope}.'            
local CitysText = 'I can take you to {Venore}, {Edron}, {Darashia} and {Port Hope}.'  
...
AbDendriel = false                                 ----> TRUE:Working/FALSE:Not Working    <---- 
...
local VenoreCost = 150                        ----> Cost to Travel for Venore    <---- 
...
Thais = false                                      ---->TRUE:Working/FALSE:Not Working<--- 
---------------------------------------END THAIS CONFIG------------------------------------------- 


---------------------------------------EDRON CONFIG----------------------------------------------- 
local EdronPosition = {x=33176, y=31764, z=6}                ----> Destination from Edron Boat <---- 
local EdronCost = 150                                     ----> Cost to Travel for Edron    <---- 
...
local PortHopeCost = 80                                     ----> Cost to Travel for Port Hope    <---- 
...
---Venore----------------------------------------------------------------------------------------------------------------------------------------- 
local VenoreText = 'Do you want to Travel to Venore for 150 gold coins?' 
...
---Thais----------------------------------------------------------------------------------------------------------------------------------------- 
local ThaisText = 'Do you want to Travel to Kazordoon for 170 gold coins?' 
...
---AbDendriel----------------------------------------------------------------------------------------------------------------------------------------- 
local AbDendrielText = 'Do you want to Travel to AbDendriel for 90 gold coins?' 
...
---Edron----------------------------------------------------------------------------------------------------------------------------------------- 
local EdronText = 'Do you want to Travel to Edron for 150 gold coins?' 
...
---Darashia----------------------------------------------------------------------------------------------------------------------------------------- 
local DarashiaText = 'Do you want to Travel to Darashia for 100 gold coins?' 
...
---Port Hope----------------------------------------------------------------------------------------------------------------------------------------- 
local PortHopeText = 'Do you want to Travel to Port Hope for 80 gold coins?' 
