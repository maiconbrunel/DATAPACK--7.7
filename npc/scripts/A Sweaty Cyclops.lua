...
-- Purpose: XVX Forger NPC (crafting/trade)
-- Notes: Handles Amulet, Obsidian Knife, Crude Iron, Draconian Steel trades
...
-- XVX FORGER: trade functions
local function amulet(cid)
