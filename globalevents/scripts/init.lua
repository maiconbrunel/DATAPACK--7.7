...
-- Purpose: Guild cleanup and server startup routines
-- Notes: Modernized loops, safe SQL handling, guild validation
...
function onStartup()
	local data, time, result = {}, os.time()
	result = db.getResult("SELECT `id`, `ownerid`, `creationdata`, `checkdata` FROM `guilds` WHERE `world_id` = " .. getConfigValue('worldId') .. ";")
